...
import stakanimg from './img/table-71380_1280 1.jpg';
import coffeimg from './img/coffee-3120750_1920 1.jpg';
import soupimg from './img/goulash-6054124_1920 2.jpg';
        ...
        return ( 
            <>
                        ...
                        <div className="col-6">
                            ...
                            <p className="text-center textp1 mt-3">Как и y любого другого самобытного места,
                                 y нас есть своя, особая история. Идея ресторана пришла
                                  ...
                                  cebe еду.</p>
                                  <ul className="d-flex ulli1 mt-5">
                                    <li className="px-3 text-center"><h1 className="textcolor">93</h1>напитки</li>
                                    <li className="px-3 text-center"><h1 className="textcolor">206</h1>Еда</li>
                                    <li className="px-3 text-center"><h1 className="textcolor">71</h1>закуски</li>
                                  </ul>
                        </div>
                        <div className="col-6 images pt-5">
                ...
                <div className="py-5">
                    ...
                    <div className="d-flex page2">
                        <div className="pizzabox">
                            <img src={pizzaimg} width={600} height={600}/>
                        </div>
                        <div className=" hamburger">
                            <img src={hamburgerimg} width={180} height={180}/>
                            <img className="my-4" src={hamburgerimg} width={180} height={180}/>
                            <img className="my-4" src={hamburgerimg} width={180} height={180}/>
                        </div>
                        <div className="list1">
                            <ul>
                ...
                <div className="biography py-5 container">
                    <p className="textp12">Я надолго запомню мой День рождения, проведённый в этом ресторане! Кусочек родной Армении!!! Отдельное спасибо за комплепент в виде фруктовой тарелки. Будем рекомендовать этот ресторан своим друзьям и родственникам также за рубежом, путешествующих в Санкт-Петербург!!!</p>
